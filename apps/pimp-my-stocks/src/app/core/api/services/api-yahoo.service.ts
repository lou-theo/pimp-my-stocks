...
export class ApiYahooService extends BaseService {
  constructor(
   ...
   */
  static readonly YahooControllerSearchPath = '/api/yahoo/search/{query}';
  ...
  yahooControllerSearch$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, ApiYahooService.YahooControllerSearchPath, 'get');
    if (params) {
   ...
   */
  static readonly YahooControllerNewsPath = '/api/yahoo/news/{query}';
  ...
  yahooControllerNews$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, ApiYahooService.YahooControllerNewsPath, 'get');
    if (params) {
      rb.path('query', params.query, {});
    }
   ...
   */
  static readonly YahooControllerQuoteSummaryPath = '/api/yahoo/quotes/{symbol}/summary';
  ...
  yahooControllerQuoteSummary$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, ApiYahooService.YahooControllerQuoteSummaryPath, 'get');
    if (params) {
   ...
   */
  static readonly YahooControllerChartPath = '/api/yahoo/quotes/{symbol}/chart';
  ...
  yahooControllerChart$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, ApiYahooService.YahooControllerChartPath, 'get');
    if (params) {
      rb.path('symbol', params.symbol, {});
